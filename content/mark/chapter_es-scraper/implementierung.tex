...
\paragraph{\mintinline{go}{func (tab *ChromeTab) thumbnail(r *map[string]interface{}) (string, error)}} \text{ }\\ Nimmt den Rückgabewert des es-extractor (Tabelle \ref{extractor:table:mercury}) und lädt dann das Vorschaubild im Feld \verb|lead_image_url| herunter und speichert es. 
